...
// through services/auth. This module only builds and parses URLs (pure
...
export function createAuthReturnUrl(): string {
...
function collectParams(params: Record<string, string>, segment: string): void {
...
export function parseAuthRedirectUrl(rawUrl: string): Record<string, string> {
