// Paginated selling-history loader — a direct port of the website's
// useMyListings hook. The panel owns the filter and remounts the list by key
// when the filter or a listings-change event arrives, so the effect only ever
// runs for a fresh user/filter pair.
