...
type AuthView = (typeof VIEWS)[keyof typeof VIEWS]
...
const VIEW_COPY: Record<AuthView, ViewCopy> = Object.freeze({
  [VIEWS.LOGIN]: {
    eyebrow: 'Sign in',
    title: 'Welcome back.',
...
function SentConfirmation({ icon, title, message }: SentConfirmationProps) {
  return (
